...
public class UsuarioController {
	...
	public String postUsuario(
		...
		if (requester.getId() != target.getId() &&
				! requester.getRol().equals(Rol.ADMIN)) {			
			response.sendError(HttpServletResponse.SC_FORBIDDEN, 
					"No eres administrador, y éste no es tu perfil");
		}
		
		if (edited.getContraseña() != null && edited.getContraseña().equals(pass2)) {
			// save encoded version of password
			target.setContraseña(passwordEncoder.encode(edited.getContraseña()));
		}		
